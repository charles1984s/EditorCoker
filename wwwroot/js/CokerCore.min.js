...
Coker.extend({ThirdParty:{PayRefund:function(a,t,e){return $.ajax({url:"/api/ThirdParty/PayRefund/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:{payment:a,ohid:t,refund:e}})},CheckRefund:function(a,t){return $.ajax({url:"/api/ThirdParty/CheckRefund/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:{payment:a,transactionId:t}})},Line:{Confirm:function(a){return $.ajax({url:"/api/ThirdParty/LinePayConfirm/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:{ohid:a}})},PayVoid:function(a){return $.ajax({url:"/api/ThirdParty/LinePayVoid/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:{ohid:a}})},CheckPaymentStatus:function(a){return $.ajax({url:"/api/ThirdParty/LinePayCheckPaymentStatus/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:{ohid:a}})}},PChomePay:{CheckStatus:function(a){return $.ajax({url:"/api/ThirdParty/PChomePayCheckPaymentStatus/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:{ohid:a}})}}}});
