...
Coker.extend({Form:{set:function(e,t){const a=document.getElementById(e);a.addEventListener("submit",(e=>{e.preventDefault(),e.stopPropagation(),a.checkValidity()&&t(),a.classList.add("was-validated")}),!1)},insertData:function(e,t){void 0===t||null==t?t=$("form").first():"string"==typeof t&&(t=/^#/.test(t)?$(t):$(`#${t}`));const a=(t,a,d)=>{switch(t){case"zipcode":co.Zipcode.setData({el:a,addr:d});break;case"date_range":a.data("daterangepicker")||_c.Picker.Init(a),e[a.data("start")]||e[a.data("end")]?(a.data("daterangepicker").setStartDate(e[a.data("start")]),a.data("daterangepicker").setEndDate(e[a.data("end")])):a.val("");break;case"date":a.data("daterangepicker")||_c.Picker.Init(a,{singleDatePicker:!0,timePicker:!1,locale:{format:"YYYY/MM/DD"}}),a.data("daterangepicker").setStartDate(d||Date.now());break;case"disabled":if(a.on("change",(function(){("reverse"==$(this).data("direct")?!$(this).prop("checked"):$(this).prop("checked"))?$(`#${$(this).data("target")}`).attr("disabled","disabled").val(""):$(`#${$(this).data("target")}`).removeAttr("disabled")})),a.data("value")){let e=$(`#${a.data("target")}`).val();"number"==typeof a.data("value")?e=parseInt(e):"string"==typeof a.data("value")&&(e=e.toString()),d="reverse"==a.data("direct")?!(a.data("value")==e):a.data("value")==e}a.prop("checked",d),a.trigger("change");break;case"images":a.data("init")||(a.ImageUploadModalClear(),a.data("init",!0)),co.File.getImgFile({Sid:e[a.data("target")],Type:a.data("image-type"),Size:a.data("image-size")}).done((function(e){e.length>0&&ImageUploadModalDataInsert(a,e[0].id,e[0].link,e[0].name)}));break;case"html":a.empty().html($("<div>").html(d).html());break;default:a.val(d)}};for(const d in e){const n=t.find(`[name="${d}"]`);if(n.length>0)if(n.data("form-type"))a(n.data("form-type"),n,e[d]);else if("INPUT"===n[0].tagName)switch(n.attr("type").toLowerCase()){case"radio":t.find(`[name="${d}"][value="${e[d]}"]`).prop("checked",!0);break;case"checkbox":Array.isArray(e[d])?$(e[d]).each((function(e,a){t.find(`[name="${d}"][value="${a}"]`).prop("checked",!0)})):t.find(`[name="${d}"][value="${e[d]}"]`).prop("checked",!0);break;case"datetime-local":n.val(co.Date.GetDateTimeStr(e[d]));break;default:n.val(e[d])}else n.val(e[d])}},getJson:function(e,t){let a=document.getElementById(e),d=new FormData(a),n=void 0!==t&&t,i=Object.fromEntries(Array.from(d.keys(),(e=>{const t=d.getAll(e);return[e,n||t.length>1?t:t.pop()]})));if($(`#${e}`).find("div[name]").each((function(){const e=$(this);switch(e.data("form-type")){case"zipcode":i[e.attr("name")]=co.Zipcode.getData(e);break;case"tags":i[e.attr("name")]=e.find(".InputTag").data("tagList")}})),i.startEndDate){const e=i.startEndDate.split("~");i.StartTime=e[0].trim(),e.length>1&&(i.EndTime=e[1].trim())}return i},getJsonByFieldset:function(e,t){const a=document.getElementById(e).querySelectorAll("input, select, textarea"),d={};return a.forEach((e=>{switch(e.type){case"checkbox":d[e.name]||(d[e.name]=[]),e.checked&&d[e.name].push(e.value);break;case"select-multiple":d[e.name]=Array.from(e.selectedOptions).map((e=>e.value));break;default:d[e.name]=e.value}})),d},init:function(e,t){const a=document.getElementById(e);a.addEventListener("submit",(d=>{$(a).find(".customValidity").get(0).setCustomValidity(""),a.checkValidity()?(d.preventDefault(),t&&t(e)):(d.preventDefault(),d.stopPropagation()),a.classList.add("was-validated")}),!1)},clear:function(e){const t=document.getElementById(e),a=$("[data-form-type]");_c.Form.insertData(_c.Form.getJson(e),`#${e}`),a.each((function(e,t){const a=$(t);switch(a.data("form-type")){case"images":a.data("init")?a.ImageUploadModalClear():(a.ImageUploadModalClear(),a.data("init",!0));break;case"date":a.data("daterangepicker").setStartDate(_c.Date.GetDateTimeStr(Date.now())),a.data("daterangepicker").setEndDate(null)}})),t.reset(),$(t).find("[name='id']").length>0&&$(t).find("[name='id']").val(0)}}});
...
Coker.extend({WebSite:{exchange:function(e){var t=$.Deferred();return $.ajax({url:"/api/Website/Exchange",type:"POST",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:JSON.stringify({Id:e}),dataType:"json"}).done((function(e){e.success&&(co.Cookie.EffectiveTime=co.Data.Time.DataRetentionLongTime,co.Cookie.Add("LastWebSite",e.message),co.Cookie.EffectiveTime=co.Data.Time.DataRetentionTime),t.resolve(e)})),t.promise()},getPrivacyAndTerms:function(){return $.ajax({url:"/api/Website/GetPrivacyAndTerms/",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header})},Save:function(e){return $.ajax({url:"/api/Website/Save",type:"POST",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:JSON.stringify(e),dataType:"json"})},LoadFrameCss:function(){return $.ajax({url:"/api/Website/LoadFrameCss",type:"GET",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,dataType:"json"})},SettingCss:function(e){let t="";const a=$.Deferred();return!function(){try{if(""==e)return!0;const t=new CSSStyleSheet;if(t.replaceSync(e),0===t.cssRules.length)throw new Error("格式不正確或包含空白內容");for(let e of t.cssRules){if(!(e instanceof CSSStyleRule))throw new Error(co.sweet.TitleHilight("字串包含不支援或無效的規則 {0}",e.cssText));if(!e.selectorText||!e.style.cssText)throw new Error(co.sweet.TitleHilight("格式不正確，缺少選擇器或屬性 {0}",e.cssText))}return!0}catch(e){return t=`CSS 格式錯誤:${e.message}`,!1}}()?a.resolve({success:!1,error:t}):$.ajax({url:"/api/Website/SettingCss",type:"POST",contentType:"application/json; charset=utf-8",headers:_c.Data.Header,data:JSON.stringify({css:e}),dataType:"json"}).done((function(e){a.resolve(e)})),a.promise()}}});