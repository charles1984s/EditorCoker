...
Coker.Object.merge(Coker.File,{ListFileInit:function(){co.File.fileUploadWithPreview(),$(".btn_upload_add > button").on("click",(function(e){e.preventDefault();var a=$(this).parents(".data_upload");UploadListAdd(null,a),5==a.data("uploadtype")&&a.find(".preview_frame>.upload_frame input").trigger("click")})),$(".youtube_frame .btn").on("click",(function(e){var a;e.preventDefault();var t=$(this).parents(".data_upload");if(t.find("ul > .upload_list").each((function(){var e=$(this);e.data("edit")&&(a=e)})),4==a.data("uploadtype")){var i=$(this).prev().val(),d="",l="",n=new URLSearchParams(i.split("?")[1]);if(i.startsWith("https://www.youtube.com/watch?"))d=n.get("v"),null==(l=n.get("t"))&&(l="0");else if(i.startsWith("https://youtu.be/")||i.startsWith("https://www.youtube.com/shorts/")||i.startsWith("https://youtube.com/shorts/")||i.startsWith("https://www.youtube.com/live/")){var o=i.split("/");d=o[o.length-1].split("?")[0],l=null==n.get("t")?n.get("start"):n.get("t")}l=l.replaceAll("s","");var s=i.indexOf("watch?v=")+8;if(t.find(".youtube_preview").children("*").remove(),""!=i&&s>-1&&""!=d){var f="https://www.youtube-nocookie.com/embed/"+d;null!=l&&(f+=`?start=${l}`);var r=`<iframe class="yt_preview w-100 h-100" src="${f}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>`;t.find(".youtube_preview").append(r),a.find(".title").text(i);var p={File:null==l?d:`${d}&t=${l}`};void 0!==total_files.find((e=>void 0!==e.Id&&e.Id==a.data("id")))?total_files.find((e=>e.Id==a.data("id"))).File.split("?")[0]!=d&&(total_files.find((e=>e.Id==a.data("id"))).File=p.File):void 0!==total_files.find((e=>e.TempId==a.data("tempid")))?total_files.find((e=>e.TempId==a.data("tempid"))).File.split("?")[0]!=d&&(total_files.find((e=>e.TempId==a.data("tempid"))).File=p.File):(p.TempId=a.data("tempid"),p.Type=a.data("uploadtype"),p.IsDelete=!1,total_files.push(p)),a.find(".thumb_img").attr("src",`https://img.youtube.com/vi/${d}/hqdefault.jpg`)}else{t.find(".youtube_preview").append("<div class='w-100 h-100 d-flex justify-content-center align-items-center bg-black bg-opacity-25 fw-bold'>請輸入正確的Youtube連結</div>"),a.find(".title").text(""),a.data("file","")}}})),$((function(){$(".data_upload > ul").each((function(e,a){$(a).sortable({items:"> .upload_list",handle:".serNoTool",cursor:"move",dropOnEmpty:!1,placeholder:"sortable-placeholder",tolerance:"pointer",start:function(e,a){a.item.data("startIndex",a.item.index()+1),a.item.offset().top,1.5*a.item.height()},stop:function(e,a){a.item.offset().top;var t=a.item.parents(".data_upload").find(".upload_list"),i=a.item.find(".ser_no"),d=a.item.data("startIndex"),l=a.item.index()+1,n=d-l;i.val(l),n<0?SortChange(t,"bigger",a.item.data("serno"),i.val()):n>=0&&SortChange(t,"smaller",i.val(),a.item.data("serno")),a.item.data("serno",i.val()),a.item.data("startIndex",l)}})}))}))},fileUploadWithPreview:function(){$(window).on("fileUploadWithPreview:imagesAdded",(function(e){var a=upload_file.cachedFileArray;$(".data_upload > ul > li").each((function(){var e=$(this);let t=e.parents(".data_upload"),i=t.data("file_num");if(e.data("edit")){switch(e.data("uploadtype")){case 1:var d=[];a.forEach((function(e,t){n=e.name.substring(0,e.name.indexOf(":")),o=e.type,d.push(new File(a.slice(t,t+1),n,{type:o}))}));var l=[];i--,d.forEach((function(a,i){var d=[];d.push(a);var l={};l.TempId=e.data("tempid")+i,l.Type=e.data("uploadtype");var n=new FileReader,o=window.URL||window.webkitURL,s=new Image,f=$.Deferred();f.promise(),s.src=o.createObjectURL(d[0]),n.readAsDataURL(d[0]),s.onload=function(){f.resolve(this.width)},n.onload=function(e){l.Link=e.target.result},f.pipe((function(e){switch(!0){case e<500:htmlImageCompress=new HtmlImageCompress(d[0],{quality:.5,width:500,imageType:d[0].type});break;case e<1e3:htmlImageCompress=new HtmlImageCompress(d[0],{quality:.7,width:800,imageType:d[0].type});break;default:htmlImageCompress=new HtmlImageCompress(d[0],{quality:.8,width:1e3,imageType:d[0].type})}return htmlImageCompress})).pipe((function(){htmlImageCompress.then((function(e){d.push(new File([e.file],e.origin.name,{type:e.file.type})),htmlImageCompress=new HtmlImageCompress(d[0],{quality:.9,width:300,imageType:d[0].type}),htmlImageCompress.then((function(e){s.src=o.createObjectURL(e.file),d.push(new File([e.file],e.origin.name,{type:e.file.type})),l.File=d,l.IsDelete=!1,l.Name=e.origin.name,total_files.push(l),UploadListAdd(l,t)})).catch((function(e){UploadPreviewFrameClear(t),console.log($`發生錯誤：${e}`),co.sweet.error("資料上傳失敗","請重新上傳",null,null)}))})).catch((function(e){UploadPreviewFrameClear(t),console.log($`發生錯誤：${e}`),co.sweet.error("資料上傳失敗","請重新上傳",null,null)}))}))}));break;case 2:d=[];a.forEach((function(e,t){n=e.name.substring(0,e.name.indexOf(":")),o=e.type,d.push(new File(a.slice(t,t+1),n,{type:o}))})),d.forEach((function(a,i){var d=[];d.push(a),htmlImageCompress=new HtmlImageCompress(d[0],{quality:.7}),htmlImageCompress.then((function(a){d.push(new File([a.file],a.origin.name,{type:a.file.type})),htmlImageCompress=new HtmlImageCompress(d[0],{quality:.3}),htmlImageCompress.then((function(a){var t={};d.push(new File([a.file],a.origin.name,{type:a.file.type})),t.File=d,t.TempId=e.data("tempid"),t.Name=a.origin.name,t.Type=e.data("uploadtype"),t.IsDelete=!1,total_files.push(t)})).catch((function(e){console.log($`發生錯誤：${e}`),UploadPreviewFrameClear(t),co.sweet.error("資料上傳失敗","請重新上傳",null,null)}))})).catch((function(e){console.log($`發生錯誤：${e}`),UploadPreviewFrameClear(t),co.sweet.error("資料上傳失敗","請重新上傳",null,null)}))})),e.find(".title").text(`${d[0].name}...共${d.length}張圖`);break;case 3:d=[];a.forEach((function(e,t){n=e.name.substring(0,e.name.indexOf(":")),o=e.type,d.push(new File(a.slice(t,t+1),n,{type:o}))}));l=[];d.forEach((function(a,t){var i={};i.File=a,i.TempId=e.data("tempid")+t,i.Type=e.data("uploadtype"),i.IsDelete=!1,i.Name=a.name,total_files.push(i),l.push(i)})),i--,l.forEach((function(e){UploadListAdd(e,t)}));break;case 5:var n,o;d=[];a.forEach((function(e,t){n=e.name.substring(0,e.name.indexOf(":")),o=e.type,d.push(new File(a.slice(t,t+1),n,{type:o}))}));l=[];d.forEach((function(a,t){var i={};i.File=a,i.TempId=e.data("tempid")+t,i.Type=e.data("uploadtype"),i.IsDelete=!1,i.Name=a.name,total_files.push(i),l.push(i)})),i--,l.forEach((function(e){UploadListAdd(e,t)}))}t.data("file_num",i)}}))})),$(window).on("fileUploadWithPreview:imageDeleted",(function(e){$(".data_upload > ul > li").each((function(){var e=$(this);if(e.data("edit")){var a=upload_file.cachedFileArray;if(a.length<1)e.data("file",""),e.find(".title").text("");else{var t=[];a.forEach((function(e,i){var d=e.name.substring(0,e.name.indexOf(":")),l=e.type;t.push(new File(a.slice(i,i+1),d,{type:l}))})),e.data("file",t)}}}))})),$(window).on("fileUploadWithPreview:clearButtonClicked",(function(e){$(".data_upload > ul > li").each((function(){var e=$(this),a=e.parents(".data_upload").find(".upload_list"),t=$(this).parents(".data_upload");let i=t.data("file_num");if(e.data("edit")){if(e.data("serno")<i&&SortChange(a,"bigger",e.data("serno"),i),void 0!==e.data("id"))total_files.find((a=>a.Id==e.data("id"))).IsDelete=!0;else if(void 0!==e.data("tempid")){var d=e.data("tempid"),l=total_files.findIndex((e=>e.TempId==d));total_files.splice(l,1),total_files.forEach((e=>{e.TempId=e.TempId>d?e.TempId-1:e.TempId}))}UploadPreviewFrameClear(t),e.remove(),i-=1,t.data("file_num",i)}}))}))},ListFile:function(e){var a=e.parents(".data_upload").first();const t=a.find(".preview_frame");let i=a.data("file_num");if(t.find(".default_frame").addClass("d-flex"),t.find(".upload_frame").addClass("d-none"),t.find(".media_frame").removeClass("d-flex"),t.find(".youtube_frame").removeClass("d-flex"),t.find(".select_frame").removeClass("d-flex"),e.data("edit"))e.data("edit",!1),e.hasClass("upload_list")&&""==e.find(".title").text()&&(e.remove(),i-=1);else switch(e.hasClass("upload_list")&&""!=e.find(".title").text()&&a.find(".upload_list").each((function(){var a=$(this);a.hasClass("upload_list")&&""==a.find(".title").text()&&(a.remove(),i=e.siblings(".upload_list").length+1)})),upload_file=null,a.find(".upload_frame").children("*").remove(),$(".upload_list").each((function(){$(this).data("edit",!1)})),e.data("edit",!0),a.find(".default_frame").removeClass("d-flex"),a.find(".youtube_preview").empty(),a.find(".media_preview > div").children().remove(),e.data("uploadtype")){case 0:var d=a.find(".select_frame");d.addClass("d-flex"),d.find("button").each((function(){$(this).on("click",(function(a){a.preventDefault(),0==e.data("uploadtype")&&(e.data("uploadtype",$(this).data("uploadtype")),e.data("edit",!1),co.File.ListFile(e))}))}));break;case 1:if(""==e.find(".title").text())upload_file=co.File.UploadImageInit("FileUpload"),a.find(".upload_frame").removeClass("d-none");else if(void 0!==e.data("id")){var l=total_files.find((a=>a.Id==e.data("id"))).Name,n=total_files.find((a=>a.Id==e.data("id"))).File;a.find(".media_frame").addClass("d-flex"),a.find(".media_frame").find("input").val(l),a.find(".media_preview > div").children().remove(),a.find(".media_preview > div").append(`<img src="${n}" class=""></img>`)}else if(void 0!==e.data("tempid")){if(void 0!==(s=total_files.find((a=>a.TempId==e.data("tempid"))))){a.find(".upload_frame").find("span").text(s.File.name),a.find(".media_frame").find("input").val(s.Name),a.find(".media_preview > div").children().remove();var o=s.Link;a.find(".media_preview > div").append(`<img src="${o}" class=""></img>`)}a.find(".media_frame").addClass("d-flex")}break;case 2:upload_file=co.File.Upload360Init("FileUpload"),e.data("file")&&(upload_file.addFiles(e.data("file")),a.find(".upload_frame").find("span").text(e.data("file").length+" 張圖片已選擇")),a.find(".upload_frame").removeClass("d-none");break;case 3:if(""==e.find(".title").text())upload_file=co.File.UploadVideoInit("FileUpload"),a.find(".upload_frame").removeClass("d-none");else if(void 0!==e.data("id")){l=total_files.find((a=>a.Id==e.data("id"))).Name,n=total_files.find((a=>a.Id==e.data("id"))).File;a.find(".media_frame").addClass("d-flex"),a.find(".media_frame").find("input").val(l),a.find(".media_preview > div").children().remove(),a.find(".media_preview > div").append(`<video src="${n}" class="h-100 w-100" controls preload="metadata"></video>`)}else if(void 0!==e.data("tempid")){var s;if(void 0!==(s=total_files.find((a=>a.TempId==e.data("tempid"))))){if(void 0!==(n=total_files.find((a=>a.TempId==e.data("tempid"))).File)){const e=URL.createObjectURL(n);var f=$("<video>",{class:"h-100 w-100",controls:!0,preload:"metadata",src:e});a.find(".media_frame").addClass("d-flex"),a.find(".media_preview > div").append(f)}a.find(".upload_frame").find("span").text(n.name),a.find(".media_frame").find("input").val(total_files.find((a=>a.TempId==e.data("tempid"))).Name)}a.find(".media_frame").addClass("d-flex")}break;case 4:if(void 0!==total_files.find((a=>void 0!==a.Id&&a.Id==e.data("id")))){var r="https://www.youtube.com/watch?v="+(n=total_files.find((a=>a.Id==e.data("id"))).File);a.find(".youtube_frame").find("input").val(r),$("#BtnConnect").click()}else if(void 0!==total_files.find((a=>a.TempId==e.data("tempid")))){r="https://www.youtube.com/watch?v="+(n=total_files.find((a=>a.TempId==e.data("tempid"))).File);a.find(".youtube_frame").find("input").val(r),$("#BtnConnect").click()}else{a.find(".youtube_frame").find("input").val("https://www.youtube.com/watch?v=");$(".youtube_preview").children("*").remove(),$(".youtube_preview").append("<div class='w-100 h-100 d-flex justify-content-center align-items-center bg-black bg-opacity-25 fw-bold'>請輸入正確的Youtube連結</div>")}a.find(".youtube_frame").addClass("d-flex");break;case 5:""==e.find(".title").text()?(upload_file=co.File.UploadFileInit("ProdFile"),a.find(".upload_frame").removeClass("d-none"),a.find(".image-preview").addClass("d-none")):a.find(".default_frame").addClass("d-flex")}a.data("file_num",i)}});
