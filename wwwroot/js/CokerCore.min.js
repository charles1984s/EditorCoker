...
Coker.extend({Form:{insertData:function(a,e){void 0===e||null==e?e=$("form").first():"string"==typeof e&&(e=$(e));const t=(e,t,d)=>{switch(e){case"zipcode":co.Zipcode.setData({el:t,addr:d});break;case"date_range":t.data("daterangepicker")||_c.Picker.Init(t),a[t.data("start")]||a[t.data("end")]?(t.data("daterangepicker").setStartDate(a[t.data("start")]),t.data("daterangepicker").setEndDate(a[t.data("end")])):t.val("");break;case"date":t.data("daterangepicker")||_c.Picker.Init(t,{singleDatePicker:!0,timePicker:!1,locale:{format:"YYYY/MM/DD"}}),t.data("daterangepicker").setStartDate(d||"");break;case"disabled":if(t.on("change",(function(){("reverse"==$(this).data("direct")?!$(this).prop("checked"):$(this).prop("checked"))?$(`#${$(this).data("target")}`).attr("disabled","disabled").val(""):$(`#${$(this).data("target")}`).removeAttr("disabled")})),t.data("value")){let a=$(`#${t.data("target")}`).val();"number"==typeof t.data("value")?a=parseInt(a):"string"==typeof t.data("value")&&(a=a.toString()),d="reverse"==t.data("direct")?!(t.data("value")==a):t.data("value")==a}t.prop("checked",d),t.trigger("change");break;case"images":t.data("init")||(t.ImageUploadModalClear(),t.data("init",!0)),co.File.getImgFile({Sid:a[t.data("target")],Type:t.data("image-type"),Size:t.data("image-size")}).done((function(a){a.length>0&&ImageUploadModalDataInsert(t,a[0].id,a[0].link,a[0].name)}));break;default:t.val(d)}};for(const d in a){const i=e.find(`[name="${d}"]`);if(i.length>0)if(i.data("form-type"))t(i.data("form-type"),i,a[d]);else if("INPUT"===i[0].tagName)switch(i.attr("type").toLowerCase()){case"radio":e.find(`[name="${d}"][value="${a[d]}"]`).prop("checked",!0);break;case"checkbox":i.prop("checked",a[d]);break;default:i.val(a[d])}else i.val(a[d]);else console.log(d)}},getJson:function(a){let e=document.getElementById(a),t=new FormData(e),d=Object.fromEntries(Array.from(t.keys(),(a=>{const e=t.getAll(a);return[a,e.length>1?e:e.pop()]})));return $(`#${a}`).find("div[name]").each((function(){const a=$(this);switch(a.data("form-type")){case"zipcode":d[a.attr("name")]=co.Zipcode.getData(a);break;case"tags":d[a.attr("name")]=a.find(".InputTag").data("tagList")}})),d},init:function(a,e){const t=document.getElementById(a);t.addEventListener("submit",(d=>{$(t).find(".customValidity").get(0).setCustomValidity(""),t.checkValidity()?(d.preventDefault(),e&&e(a)):(d.preventDefault(),d.stopPropagation()),t.classList.add("was-validated")}),!1)},clear:function(a){const e=document.getElementById(a),t=$("[data-form-type]");_c.Form.insertData(_c.Form.getJson(a),`#${a}`),t.each((function(a,e){const t=$(e);if("images"===t.data("form-type"))t.data("init")?t.ImageUploadModalClear():(t.ImageUploadModalClear(),t.data("init",!0))})),e.reset()}}});
...
Coker.Object.merge(Coker.File,{ListFile:function(e){var d=e.parents(".data_upload").first();const a=d.find(".preview_frame");if(a.find(".default_frame").addClass("d-flex"),a.find(".upload_frame").addClass("d-none"),a.find(".media_frame").removeClass("d-flex"),a.find(".youtube_frame").removeClass("d-flex"),a.find(".select_frame").removeClass("d-flex"),e.data("edit"))e.data("edit",!1),e.hasClass("upload_list")&&""==e.find(".title").text()&&(e.remove(),file_num-=1);else switch(e.hasClass("upload_list")&&""!=e.find(".title").text()&&$(".upload_list").each((function(){var d=$(this);d.hasClass("upload_list")&&""==d.find(".title").text()&&(d.remove(),file_num=e.siblings(".upload_list").length+1)})),upload_file=null,d.find(".upload_frame").children("*").remove(),$(".upload_list").each((function(){$(this).data("edit",!1)})),e.data("edit",!0),d.find(".default_frame").removeClass("d-flex"),e.data("uploadtype")){case 0:var i=d.find(".select_frame");i.addClass("d-flex"),i.find("button").each((function(){$(this).on("click",(function(d){d.preventDefault(),0==e.data("uploadtype")&&(e.data("uploadtype",$(this).data("uploadtype")),e.data("edit",!1),UploadFile(e))}))}));break;case 1:if(""==e.find(".title").text())upload_file=co.File.UploadImageInit("FileUpload"),d.find(".upload_frame").removeClass("d-none");else if(void 0!==e.data("id")){var t=total_files.find((d=>d.Id==e.data("id"))).Name,l=total_files.find((d=>d.Id==e.data("id"))).File;d.find(".media_frame").addClass("d-flex"),d.find(".media_frame").find("input").val(t),d.find(".media_preview > div").children().remove(),d.find(".media_preview > div").children().remove(),d.find(".media_preview > div").append(`<img src="${l}" class=""></img>`)}else if(void 0!==e.data("tempid")){if(void 0!==(n=total_files.find((d=>d.TempId==e.data("tempid"))))){d.find(".upload_frame").find("span").text(n.File.name),d.find(".media_frame").find("input").val(n.Name),d.find(".media_preview > div").children().remove();var f=n.Link;d.find(".media_preview > div").append(`<img src="${f}" class=""></img>`)}d.find(".media_frame").addClass("d-flex")}break;case 2:upload_file=co.File.Upload360Init("FileUpload"),e.data("file")&&(upload_file.addFiles(e.data("file")),d.find(".upload_frame").find("span").text(e.data("file").length+" 張圖片已選擇")),d.find(".upload_frame").removeClass("d-none");break;case 3:if(""==e.find(".title").text())upload_file=co.File.UploadVideoInit("FileUpload"),d.find(".upload_frame").removeClass("d-none");else if(void 0!==e.data("id")){t=total_files.find((d=>d.Id==e.data("id"))).Name,l=total_files.find((d=>d.Id==e.data("id"))).File;d.find(".media_frame").addClass("d-flex"),d.find(".media_frame").find("input").val(t),d.find(".media_preview > div").children().remove(),d.find(".media_preview > div").append(`<video src="${l}" class="h-100 w-100" controls preload="metadata"></video>`)}else if(void 0!==e.data("tempid")){var n;void 0!==(n=total_files.find((d=>d.TempId==e.data("tempid"))))&&(l=total_files.find((d=>d.TempId==e.data("tempid"))).File,d.find(".upload_frame").find("span").text(l.name),d.find(".media_frame").find("input").val(total_files.find((d=>d.TempId==e.data("tempid"))).Name)),d.find(".media_frame").addClass("d-flex")}break;case 4:if(void 0!==total_files.find((d=>d.Id==e.data("id")))){var o="https://www.youtube.com/watch?v="+(l=total_files.find((d=>d.Id==e.data("id"))).File);d.find(".youtube_frame").find("input").val(o),$("#BtnConnect").click()}else if(void 0!==total_files.find((d=>d.TempId==e.data("tempid")))){o="https://www.youtube.com/watch?v="+(l=total_files.find((d=>d.TempId==e.data("tempid"))).File);d.find(".youtube_frame").find("input").val(o),$("#BtnConnect").click()}else{d.find(".youtube_frame").find("input").val("https://www.youtube.com/watch?v=");$(".youtube_preview").children("*").remove(),$(".youtube_preview").append("<div class='w-100 h-100 d-flex justify-content-center align-items-center bg-black bg-opacity-25 fw-bold'>請輸入正確的Youtube連結</div>")}d.find(".youtube_frame").addClass("d-flex")}}}),jQuery.fn.extend({});
...
Coker.extend({sweet:{config:{timeout:1500},success:function(t,o,n){var e=!1;n&&(e=Coker.sweet.config.timeout),Swal.fire({icon:"success",html:t,showConfirmButton:!n,showCancelButton:!1,confirmButtonColor:"#3085d6",confirmButtonText:"確定",timer:e}).then((t=>{t.isConfirmed&&"function"==typeof o&&o()}))},error:function(t,o,n,e){var i=!1;e&&(i=Coker.sweet.config.timeout),Swal.fire({icon:"error",title:t,html:o,showConfirmButton:!e,showCancelButton:!1,confirmButtonColor:"#3085d6",confirmButtonText:"確定",reverseButtons:!0,timer:i}).then((t=>{t.isConfirmed&&"function"==typeof n&&n()}))},confirm:function(t,o,n,e,i){Swal.fire({icon:"info",title:t,html:o,showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:n,cancelButtonText:e,reverseButtons:!0}).then((t=>{t.isConfirmed&&"function"==typeof i&&i()}))},warn:function(t,o,n){Swal.fire({icon:"warning",title:t,html:o,showConfirmButton:!0,showCancelButton:!1,confirmButtonColor:"#3085d6",confirmButtonText:"確定",reverseButtons:!0}).then((t=>{t.isConfirmed&&"function"==typeof n&&n()}))},TitleHilight:function(t,o){return t.replace("{0}",`<span class='ConfirmKeyWord'>${o}</span>`)}}});
