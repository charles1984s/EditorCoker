...
Coker.extend({Form:{set:function(e,a){const t=document.getElementById(e);t.addEventListener("submit",(e=>{e.preventDefault(),e.stopPropagation(),t.checkValidity()&&a(),t.classList.add("was-validated")}),!1)},insertData:function(e,a){void 0===a||null==a?a=$("form").first():"string"==typeof a&&(a=$(a));const t=(a,t,d)=>{switch(a){case"zipcode":co.Zipcode.setData({el:t,addr:d});break;case"date_range":t.data("daterangepicker")||_c.Picker.Init(t),e[t.data("start")]||e[t.data("end")]?(t.data("daterangepicker").setStartDate(e[t.data("start")]),t.data("daterangepicker").setEndDate(e[t.data("end")])):t.val("");break;case"date":t.data("daterangepicker")||_c.Picker.Init(t,{singleDatePicker:!0,timePicker:!1,locale:{format:"YYYY/MM/DD"}}),t.data("daterangepicker").setStartDate(d||Date.now());break;case"disabled":if(t.on("change",(function(){("reverse"==$(this).data("direct")?!$(this).prop("checked"):$(this).prop("checked"))?$(`#${$(this).data("target")}`).attr("disabled","disabled").val(""):$(`#${$(this).data("target")}`).removeAttr("disabled")})),t.data("value")){let e=$(`#${t.data("target")}`).val();"number"==typeof t.data("value")?e=parseInt(e):"string"==typeof t.data("value")&&(e=e.toString()),d="reverse"==t.data("direct")?!(t.data("value")==e):t.data("value")==e}t.prop("checked",d),t.trigger("change");break;case"images":t.data("init")||(t.ImageUploadModalClear(),t.data("init",!0)),co.File.getImgFile({Sid:e[t.data("target")],Type:t.data("image-type"),Size:t.data("image-size")}).done((function(e){e.length>0&&ImageUploadModalDataInsert(t,e[0].id,e[0].link,e[0].name)}));break;case"html":t.empty().html($("<div>").html(d).html());break;default:t.val(d)}};for(const d in e){const n=a.find(`[name="${d}"]`);if(n.length>0)if(n.data("form-type"))t(n.data("form-type"),n,e[d]);else if("INPUT"===n[0].tagName)switch(n.attr("type").toLowerCase()){case"radio":a.find(`[name="${d}"][value="${e[d]}"]`).prop("checked",!0);break;case"checkbox":Array.isArray(e[d])?$(e[d]).each((function(e,t){a.find(`[name="${d}"][value="${t}"]`).prop("checked",!0)})):a.find(`[name="${d}"][value="${e[d]}"]`).prop("checked",!0);break;case"datetime-local":n.val(co.Date.GetDateTimeStr(e[d]));break;default:n.val(e[d])}else n.val(e[d])}},getJson:function(e,a){let t=document.getElementById(e),d=new FormData(t),n=void 0!==a&&a,i=Object.fromEntries(Array.from(d.keys(),(e=>{const a=d.getAll(e);return[e,n||a.length>1?a:a.pop()]})));if($(`#${e}`).find("div[name]").each((function(){const e=$(this);switch(e.data("form-type")){case"zipcode":i[e.attr("name")]=co.Zipcode.getData(e);break;case"tags":i[e.attr("name")]=e.find(".InputTag").data("tagList")}})),i.startEndDate){const e=i.startEndDate.split("~");i.StartTime=e[0].trim(),e.length>1&&(i.EndTime=e[1].trim())}return i},getJsonByFieldset:function(e,a){const t=document.getElementById(e).querySelectorAll("input, select, textarea"),d={};return t.forEach((e=>{switch(e.type){case"checkbox":d[e.name]||(d[e.name]=[]),e.checked&&d[e.name].push(e.value);break;case"select-multiple":d[e.name]=Array.from(e.selectedOptions).map((e=>e.value));break;default:d[e.name]=e.value}})),d},init:function(e,a){const t=document.getElementById(e);t.addEventListener("submit",(d=>{$(t).find(".customValidity").get(0).setCustomValidity(""),t.checkValidity()?(d.preventDefault(),a&&a(e)):(d.preventDefault(),d.stopPropagation()),t.classList.add("was-validated")}),!1)},clear:function(e){const a=document.getElementById(e),t=$("[data-form-type]");_c.Form.insertData(_c.Form.getJson(e),`#${e}`),t.each((function(e,a){const t=$(a);switch(t.data("form-type")){case"images":t.data("init")?t.ImageUploadModalClear():(t.ImageUploadModalClear(),t.data("init",!0));break;case"date":t.data("daterangepicker").setStartDate(_c.Date.GetDateTimeStr(Date.now())),t.data("daterangepicker").setEndDate(null)}})),a.reset(),$(a).find("[name='id']").length>0&&$(a).find("[name='id']").val(0)}}});
