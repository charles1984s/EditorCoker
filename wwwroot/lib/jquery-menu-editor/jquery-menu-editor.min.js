function MenuEditor(e,t){var s=this,n=$("#"+e).data("level","0"),l={labelEdit:'<i class="fas fa-edit clickable"></i>',labelRemove:'<i class="fas fa-trash-alt clickable"></i>',textConfirmDelete:"This item {0} will be deleted. Are you sure?",iconPicker:{cols:4,rows:4,footer:!1,iconset:"fontawesome5"},maxLevel:-1,listOptions:{hintCss:{border:"1px dashed #13981D"},opener:{as:"html",close:'<i class="fas fa-minus"></i>',open:'<i class="fas fa-plus"></i>',openerCss:{"margin-right":"10px",float:"none"},openerClass:"btn btn-outline-success btn-sm"},placeholderCss:{"background-color":"gray"},ignoreClass:"clickable",listsClass:"pl-0",listsCss:{"padding-top":"10px"},complete:function(e){return MenuEditor.updateButtons(n),n.updateLevels(0),l.on.drop&&l.on.drop(e),!0},isAllowed:function(e,t,s){return g(e,s)}},on:{}};$.extend(!0,l,t);var o=null,i=!0,r=null,a=null,c=l.iconPicker,d=(t=l.listOptions,$("#"+e+"_icon").iconpicker(c));function p(e){var t=e.data();$.each(t,(function(e,t){let s=r.find("[name="+e+"]");if(!(s.length<=0))if("SELECT"===s[0].tagName)s.find("[value="+e+"]").prop("selected",!0);else if("RADIO"===s.attr("type").toUpperCase())s.find("[value="+e+"]").prop("checked",!0);else s.val(t)})),r.find(".item-menu").first().focus(),t.hasOwnProperty("icon")?d.iconpicker("setIcon",t.icon):d.iconpicker("setIcon","empty"),a.removeAttr("disabled")}function u(){r[0].reset(),(d=d.iconpicker(c)).iconpicker("setIcon","empty"),a.attr("disabled",!0),o=null}function f(e){return $("<a>").addClass(e.classCss).addClass("clickable").attr("href","#").html(e.text)}function h(){var e=$("<div>").addClass("btn-group float-right"),t=f({classCss:"btn btn-primary btn-sm btnEdit",text:l.labelEdit}),s=f({classCss:"btn btn-danger btn-sm btnRemove",text:l.labelRemove}),n=f({classCss:"btn btn-secondary btn-sm btnUp btnMove",text:'<i class="fas fa-angle-up clickable"></i>'}),o=f({classCss:"btn btn-secondary btn-sm btnDown btnMove",text:'<i class="fas fa-angle-down clickable"></i>'}),i=f({classCss:"btn btn-secondary btn-sm btnOut btnMove",text:'<i class="fas fa-level-down-alt clickable"></i>'}),r=f({classCss:"btn btn-secondary btn-sm btnIn btnMove",text:'<i class="fas fa-level-up-alt clickable"></i>'}),a=f({classCss:"btn btn-success btn-sm btnPage",text:'<i class="fa fa-paint-roller clickable"></i>'});return e.append(n).append(o).append(r).append(i).append(t).append(s).append(a),e}function v(e,t){var s=void 0===t?0:t,l=0===s?n:$("<ul>").addClass("pl-0").css("padding-top","10px").data("level",s);return $.each(e,(function(e,t){var n=void 0!==t.children&&$.isArray(t.children),o={text:"",href:"",icon:"empty",target:"_self",title:""},i=$.extend({},t);n&&delete i.children,$.extend(o,i);var r=$("<li>").addClass("list-group-item pr-0");r.data(o);var a=$("<div>").css("overflow","auto"),c=$("<i>").addClass(t.icon),d=$("<span>").addClass("txt font-weight-bold").append(t.text).css("margin-right","5px"),p=h();a.append(c).append("&nbsp;").append(d).append(p),r.append(a),n&&r.append(v(t.children,s+1)),l.append(r)})),l}function b(e){var s=$("<span>").addClass("sortableListsOpener "+t.opener.openerClass).css(t.opener.openerCss).on("mousedown touchstart",(function(e){var s=$(this).closest("li");return s.hasClass("sortableListsClosed")?s.iconOpen(t):s.iconClose(t),!1}));s.prependTo(e.children("div").first()),e.hasClass("sortableListsOpen")?e.iconOpen(t):e.iconClose(t)}function g(e,t){if(l.maxLevel<0)return!0;var s=0,n=e.find("ul").length;return s=0==t.length?0:parseInt(t.parent().data("level"))+1,console.log(s+n),s+n<=l.maxLevel}if(n.sortableLists(l.listOptions),d.on("change",(function(e){r.find("[name=icon]").val(e.icon)})),n.on("click",".btnRemove",(function(t){t.preventDefault();var s=this,o=$(this).closest("li").data(),i=o.text;co.sweet.confirm("即將刪除",l.textConfirmDelete.replace("{0}",i),"確認","取消",(function(){var t=$(s).closest("ul");$(s).closest("li").remove();var i=!1;void 0!==t.attr("id")&&(i=t.attr("id").toString()===e),t.children().length||i||(t.prev("div").children(".sortableListsOpener").first().remove(),t.remove()),l.on.del&&l.on.del(o),MenuEditor.updateButtons(n)}))})),n.on("click",".btnPage",(function(e){e.preventDefault(),o=$(this).closest("li"),l.on.page&&l.on.page($(o).data()),p(o)})),n.on("click",".btnEdit",(function(e){e.preventDefault(),p(o=$(this).closest("li")),l.on.edit&&l.on.edit()})),n.on("click",".btnUp",(function(e){e.preventDefault();var t=$(this).closest("li");t.prev("li").before(t),MenuEditor.updateButtons(n),l.on.drop&&l.on.drop(t)})),n.on("click",".btnDown",(function(e){e.preventDefault();var t=$(this).closest("li");t.next("li").after(t),MenuEditor.updateButtons(n),l.on.drop&&l.on.drop(t)})),n.on("click",".btnOut",(function(e){e.preventDefault();var t=$(this).closest("ul"),s=$(this).closest("li");s.closest("ul").closest("li").after(s),t.children().length<=0&&(t.prev("div").children(".sortableListsOpener").first().remove(),t.remove()),MenuEditor.updateButtons(n),n.updateLevels(),l.on.drop&&l.on.drop(s)})),n.on("click",".btnIn",(function(e){e.preventDefault();var t=$(this).closest("li"),s=t.prev("li");if(!g(t,s))return!1;if(s.length>0)if((o=s.children("ul")).length>0)o.append(t);else{var o=$("<ul>").addClass("pl-0").css("padding-top","10px");s.append(o),o.append(t),s.addClass("sortableListsOpen"),b(s)}MenuEditor.updateButtons(n),n.updateLevels(),l.on.drop&&l.on.drop(t)})),s.setForm=function(e){r=e},s.getForm=function(){return r},s.setUpdateButton=function(e){(a=e).attr("disabled",!0),o=null},s.getUpdateButton=function(){return a},s.getCurrentItem=function(){return o},s.update=function(){var e=s.getCurrentItem();if(null!==e){var t=e.data("icon");r.find(".item-menu").each((function(){e.data($(this).attr("name"),$(this).val())})),e.data("text",e.data("title")),e.children().children("i").removeClass(t).addClass(e.data("icon")),e.find("span.txt").first().text(e.data("text")),l.on.update&&l.on.update(e.data()),u()}},s.add=function(){var e={};if(r[0].checkValidity()){r.find(".item-menu").each((function(){e[$(this).attr("name")]=$(this).val()})),""==e.Id&&(e.Id=0),""==e.SerNO&&(e.SerNO=500),e.text=e.title;var t=h(),s=$("<span>").addClass("txt font-weight-bold").text(e.title),o=$("<i>").addClass(e.icon),i=$("<div>").css({overflow:"auto"}).append(o).append("&nbsp;").append(s).append(t),a=$("<li>").data(e);a.addClass("list-group-item pr-0").append(i),n.append(a),MenuEditor.updateButtons(n),u(),l.on.add&&l.on.add(a)}else r.addClass("was-validated")},s.refresh=function(){u()},s.getString=function(){var e=n.sortableListsToJson();return JSON.stringify(e)},s.setData=function(e){var t=Array.isArray(e)?e:function(e){try{var t=JSON.parse(e)}catch(e){return console.log("The string is not a json valid."),null}return t}(e);if(null!==t){n.empty();var s=v(t);i?n.find("li").each((function(){var e=$(this);e.children("ul").length&&b(e)})):(s.sortableLists(l.listOptions),i=!0),MenuEditor.updateButtons(n)}},l.element){var m=l.element;s.setForm($(m.Form)),s.setUpdateButton($(m.Update)),$(m.Update).click(s.update),$(m.Add).click(s.add),$(m.Refresh).click(s.refresh)}l.on.ready&&l.on.ready()}!function(e){
/**
